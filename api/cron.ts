...
import { dummyData } from '../src/build/dummyContribData';
import type { Contributor, LeaderboardAdminData } from '../src/lib/util/fetchContributors'
...
function sortContributors(contributorData: any[], param?: string) {
